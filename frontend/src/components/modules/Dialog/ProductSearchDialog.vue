<template>
<modal name="product-dialog" :draggable="true" :adaptive="true" :scrollable="true" width="75%" height="auto">
    <div class="container">
        ...
        <div class="row margin-15">
            <div class="col">
                <div class="input-group mb-1" id="modal-search-form">
                    ...
                    <input v-model="product.productName" type="text" class="col-md-3" id="product_name" placeholder="入力してください"/>
    ...
    methods: {
        getAllProductList: function() {
            ...
            .then((res) => {
                ...
                console.log('retrieve all Product');
            })
            .catch((err) => {
        ...
        getProductListByLikeName: function() {
            ...
            .then(res => {
                this.products = res.data;
                console.log('retrieve a Product by :name');
            })
            .catch(err => {
                console.log('Error' + err);
            })
